        ...
        <div className="flex-col flex">
          <div className="w-full border-b-2 border-black">
            <div className="bg-white h-16 justify-between items-center mx-auto px-4 flex">
              <div>
                <h className="font-bold capitalize text-4xl mb-12">ReadMeEasy</h>
              </div>
              ...
              <div className="md:space-x-6 justify-end items-center ml-auto flex space-x-3">
                ...
                hover:text-gray-900 focus:outline-none hover:bg-gray-100">
                  ...
                  <p className="px-1.5 py-0.5 font-semibold text-xs items-center bg-lime-400 text-white rounded-full inline-flex
                absolute -top-px -right-1">2</p>
                </div>
                <a href="https://github.com/Pavel401/react-readme" target="_blank" rel="noopener noreferrer">
                <button class="h-12 border-black border-2 p-2.5 bg-lime-400 hover:bg-lime-400 hover:shadow-[2px_2px_0px_rgba(0,0,0,1)] active:bg-lime-400 rounded-md">GitHub </button>
                </a>
              </div>
            </div>
          </div>
